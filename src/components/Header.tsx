      ...
      <div className="w-full px-4 sm:px-6 lg:px-8 py-4">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-5 sm:gap-6">
            ...
            <Link
              to="/ambassadeur"
              className="hidden sm:flex items-center gap-2 text-base text-muted-foreground hover:text-accent transition-colors"
            >
          ...
          <div className="hidden sm:flex items-center gap-4">
            <a
              href="#cta"
              className="px-6 py-3 bg-accent/10 text-accent font-semibold text-base rounded-full hover:bg-accent hover:text-white transition-all duration-300"
            >
              Rejoindre la bêta
            </a>
            <Link
          ...
          <div className="flex sm:hidden items-center gap-3">
            <a
              href="#cta"
              className="px-4 py-2 bg-accent/10 text-accent font-semibold text-sm rounded-full hover:bg-accent hover:text-white transition-all duration-300"
            >
              Rejoindre la bêta
            </a>
            <button
