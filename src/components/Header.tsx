    ...
    >
      <div className="container-narrow py-4">
        <div className="flex items-center justify-between">
          ...
          {/* Right: Rejoindre la bêta + Discord */}
          <div className="flex items-center gap-3">
            <a
              href="#cta"
              className="px-4 py-2 sm:px-5 sm:py-2.5 bg-accent/10 text-accent font-medium text-sm rounded-full hover:bg-accent hover:text-white transition-all duration-300"
            >
              Rejoindre la bêta
            </a>
            <a
              ...
              className="w-9 h-9 flex items-center justify-center rounded-full bg-muted/50 hover:bg-accent/20 transition-colors"
              title="Discord"
            >
              <svg
