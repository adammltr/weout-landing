        ...
        <div className="flex flex-col items-center text-center gap-6">
          ...
          <div className="flex items-center gap-3">
            <a 
              ...
              className="w-10 h-10 flex items-center justify-center rounded-full bg-card/50 border border-border/40 text-muted-foreground hover:text-accent hover:border-accent/40 transition-all"
              title="Instagram"
            >
              <svg 
                viewBox="0 0 24 24" 
