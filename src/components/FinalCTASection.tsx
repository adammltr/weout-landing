      ...
      <div className="container-narrow relative z-10">
        <div className="text-center">
          ...
          <h2 className="text-3xl md:text-4xl font-bold mb-5">
            Reste informé de <span className="text-accent">l'avancement</span>.
          </h2>
          ...
          <p className="text-sm text-foreground/70 mb-10 flex items-center justify-center gap-2">
            ...
            Sois prévenu dès l'ouverture de la bêta
          </p>
          ...
          <div className="flex flex-col items-center gap-4">
            ...
            >
              ...
              Discord (retours & bugs)
            </a>
          </div>
          
          <p className="text-xs text-muted-foreground mt-6">
            Échanges directs et accès anticipé aux nouvelles fonctionnalités.
          </p>
        </div>
      </div>
    </section>
