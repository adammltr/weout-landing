    ...
    <main className="min-h-screen bg-background flex items-center justify-center">
      <div className="container-narrow py-12">
        ...
        <div className="text-center">
          ...
          <h1 className="section-title mb-4">Rejoins le Discord WeOut</h1>
          <p className="section-subtitle max-w-xl mx-auto mb-8">
            Échange avec l'équipe et les autres early adopters, partage tes
            idées et sois le premier informé des nouveautés.
          </p>
